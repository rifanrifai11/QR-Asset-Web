...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $jobsite->id !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $jobsite->nama !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $jobsite->keterangan !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $jobsite->created_at !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $jobsite->updated_at !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $jobsite->deleted_at !!}</p>
    </div>
</div>
