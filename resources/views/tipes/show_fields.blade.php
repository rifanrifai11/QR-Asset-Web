...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $tipe->id !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $tipe->nama !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $tipe->keterangan !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $tipe->created_at !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $tipe->updated_at !!}</p>
    </div>
</div>
...
<div class="form-group row mb-1">
    ...
    <div class="col-md-9">
        <p class="form-control">{!! $tipe->deleted_at !!}</p>
    </div>
</div>
