<li class="{{  Request::is('roles*')||Request::is('permissions*')||Request::is('user_role*')||Request::is('users*') ? 'active' : '' }} nav-item">
    <a href="#"><i class="fa fa-cog"></i><span class="menu-title" data-i18n="nav.color_palette.main">Role & User</span></a>
...
<li class="{{  Request::is('umurEkonomis*')||Request::is('departemens*')||Request::is('kondisiAsets*')||Request::is('kategoriAsets*') ||Request::is('grubAsets*')||Request::is('vendors*')||Request::is('mereks*')||Request::is('tipes*')||Request::is('asets*')||Request::is('jobsites*')||Request::is('lokasis*') ? 'active' : '' }} nav-item">
    <a href="#"><i class="fa fa-cog"></i><span class="menu-title" data-i18n="nav.color_palette.main">Master Data</span></a>
    <ul class="menu-content">
        <ul class="treeview-menu">
