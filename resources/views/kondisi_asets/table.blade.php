    ...
    @foreach($kondisiAsets as $kondisiAset)
        <tr>
            ...
            <td class="text-center ">
                ...
                <div class='btn-group'>
                    <a href="{!! route('kondisiAsets.show', [$kondisiAset->id]) !!}" class='btn btn-icon btn-sm btn-outline-success'><i class="fa fa-eye"></i></a>
                    <a href="{!! route('kondisiAsets.edit', [$kondisiAset->id]) !!}" class='btn btn-icon btn-sm btn-outline-warning'><i class="fa fa-pencil"></i></a>
